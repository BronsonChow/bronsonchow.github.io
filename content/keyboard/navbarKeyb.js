            ...
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="keyb.html">Custom Keyboard Info</a></li>
                        <li><a class="dropdown-item" href="../voca/voca.html">Vocaloid Stuff</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="../../labs/StarterPage.html">Lab 2 - Starter Page</a></li>
